        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8 pb-8 border-b border-border/50">
          <div className="md:col-span-2">
            ...
            <p className="text-foreground/70 max-w-sm">
              Diseñando y desarrollando aplicaciones web excepcionales que impulsan el crecimiento de los negocios.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#about" className="text-foreground/70 hover:text-primary-600 transition-colors">Sobre mí</a></li>
              <li><a href="#services" className="text-foreground/70 hover:text-primary-600 transition-colors">Servicios</a></li>
              <li><a href="#portfolio" className="text-foreground/70 hover:text-primary-600 transition-colors">Portfolio</a></li>
              <li><a href="#contact" className="text-foreground/70 hover:text-primary-600 transition-colors">Contacto</a></li>
            </ul>
          </div>
